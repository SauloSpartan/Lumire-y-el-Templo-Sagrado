...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class FindOverlaps : ComponentAction<Transform>
    {
        ...
        [Tooltip("Set how often to cast a ray. 0 = once, don't repeat; 1 = everyFrame; 2 = every other frame... \nSince Overlaps can get expensive use the highest repeat interval you can get away with.")]
        ...
        private void DoGetOverlap()
        {
            ...
            targetMask = LayerMask.GetMask(LayerMask.LayerToName(layerMask.Value));
